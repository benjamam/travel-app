...
export class MapsAPIService {
    ...
    getGPSCoordinates(location: LocationSearch): Observable<CoordResponse> {
        const url: string = 'https://maps.googleapis.com/maps/api/geocode/json?components=locality:' + location.city +
            '|country:' + location.country + '&key=AIzaSyDb1bjMXaA13YQLpIct8RBn2jm0TORQC7E';
